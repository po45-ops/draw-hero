(function () {
  "use strict";
  const characters = [
    { id:"es", name:"Es", title:"นักเวทแห่งแสง", class:"Mage", level:1, hp:3, color:"#37b9ff", stats:{power:72,speed:64,magic:96}, skill:"arcaneTime", passive:"Arcane Time", ultimate:"Magic Burst", description:"ผู้ควบคุมแสงดาวและเวทอาร์เคน เพิ่มเวลาตอบโจทย์ 2 วินาที", unlockLevel:1, portrait:"assets/characters/es_idle.png", battleSprite:"assets/characters/es_battle.png", weapon:"staff" },
    { id:"kai", name:"Kai", title:"นักดาบผู้กล้า", class:"Warrior", level:1, hp:4, color:"#ef5555", stats:{power:95,speed:78,magic:48}, skill:"comboSlash", passive:"Combo Slash", ultimate:"Dragon Slash", description:"นักรบใจกล้าที่โจมตีซ้ำฟรีเมื่อตอบถูกติดต่อกัน 5 ครั้ง", unlockLevel:1, portrait:"assets/characters/kai_idle.png", battleSprite:"assets/characters/kai_battle.png", weapon:"sword" },
